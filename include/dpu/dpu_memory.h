...
/**
 * @fn dpu_copy_to_wram_for_matrix
 * @brief Copy some words to the WRAM of some DPUs of a rank.
 * @param rank the DPU rank
 * @param wram_word_offset where to start to copy the words in WRAM
 * @param sources the buffers containing the data to copy
 * @param nb_of_words the number of words to copy
 * @return Whether the operation was successful.
 */
dpu_error_t
dpu_copy_to_wram_for_matrix(struct dpu_rank_t *rank,
    wram_addr_t wram_word_offset,
    const dpuword_t **sources,
    wram_size_t nb_of_words);
...
/**
 * @fn dpu_copy_from_wram_for_matrix
 * @brief Copy some words from the WRAM of some DPUs of a rank.
 * @param rank the DPU rank
 * @param destinations the buffers where the words will be stored
 * @param wram_word_offset where to start to copy the words from WRAM
 * @param nb_of_words the number of words to copy
 * @return Whether the operation was successful.
 */
dpu_error_t
dpu_copy_from_wram_for_matrix(struct dpu_rank_t *rank,
    dpuword_t **destinations,
    wram_addr_t wram_word_offset,
    wram_size_t nb_of_words);
 ...
 */
dpu_error_t
dpu_copy_to_mrams(struct dpu_rank_t *rank, struct dpu_transfer_mram *transfer_matrix, mram_size_t size, mram_addr_t offset);
 ...
 */
dpu_error_t
dpu_copy_from_mrams(struct dpu_rank_t *rank, struct dpu_transfer_mram *transfer_matrix, mram_size_t size, mram_addr_t offset);
